...
install teaching elders contains no record of the following:
1. The pronouncement of installation ( _BCO_ 21-7);
2. The charge to the congregation ( _BCO_ 21-7);
3. That the TEs answered the constitutional questions in the
