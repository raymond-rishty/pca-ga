...
portions of the trials are waived with a reference to _BCO_ 21-4. If this
is intended to waive the parts on the basis of a previous licensure
exam, the previous exam should be referenced. _BCO_ 19-2, 21-4; _RAO_
14-3.e.5.

**Response:** The Sun Coast Florida Presbytery agrees with the
exception and corrects its records (when possible), corrects its actions
